...
using RoyalEstate.Sessions;
using RoyalEstate.Web.Models.Account;
using RoyalEstate.Web.Views.Shared.Components.TenantChange;

namespace RoyalEstate.Web.Controllers
{
    public class AccountController : RoyalEstateControllerBase
    {
