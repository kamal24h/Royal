...
namespace RoyalEstate.Migrations
{
    ...
    [Migration("20210217041954_removed_serviceType_from_estates_table")]
    partial class removed_serviceType_from_estates_table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoyalEstate.Entities.District", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RoyalEstate.Entities.EstateImage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("RoyalEstate.Entities.Province", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RoyalEstate.Entities.ServiceType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("RoyalEstate.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("RoyalEstate.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("RoyalEstate.Entities.Estate", b =>
                {
                    ...
                    b.HasOne("RoyalEstate.Entities.Customer", "Customer")
                        .WithMany("Estates")
