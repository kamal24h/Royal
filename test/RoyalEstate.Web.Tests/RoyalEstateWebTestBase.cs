...
{
    public abstract class RoyalEstateWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static RoyalEstateWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(RoyalEstateWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<RoyalEstateDbContext> action)
        {
            using (var context = IocManager.Resolve<RoyalEstateDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<RoyalEstateDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<RoyalEstateDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<RoyalEstateDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<RoyalEstateDbContext, Task<T>> func)
        {
            T result;
